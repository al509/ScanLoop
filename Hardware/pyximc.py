...
class StateFlags:
	...
	STATE_ERRD                      = 0x00002
	STATE_ERRV                      = 0x00004
	STATE_EEPROM_CONNECTED          = 0x00010
	STATE_IS_HOMED                  = 0x00020
	STATE_SECUR                     = 0x3FFC0
	STATE_ALARM                     = 0x00040
	STATE_CTP_ERROR                 = 0x00080
	STATE_POWER_OVERHEAT            = 0x00100
	STATE_CONTROLLER_OVERHEAT       = 0x00200
	STATE_OVERLOAD_POWER_VOLTAGE    = 0x00400
	STATE_OVERLOAD_POWER_CURRENT    = 0x00800
	STATE_OVERLOAD_USB_VOLTAGE      = 0x01000
	STATE_LOW_USB_VOLTAGE           = 0x02000
	STATE_OVERLOAD_USB_CURRENT      = 0x04000
	STATE_BORDERS_SWAP_MISSET       = 0x08000
